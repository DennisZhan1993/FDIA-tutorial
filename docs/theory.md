...
where $x=[\theta_2,\theta_3]^T$, bus 1 is the reference, and $e$ is Gaussian measurement noise.
...
If $a$ does not respect the measurement-model structure, it often causes the residual statistic to increase.
...
All experiments in this repository are synthetic and offline. They are intended for classroom learning, state-estimation research, and defensive algorithm evaluation.
